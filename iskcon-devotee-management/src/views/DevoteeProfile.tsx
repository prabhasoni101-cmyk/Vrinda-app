...
export default function DevoteeProfile() {
  ...
  const canEdit = true; // Everyone can edit address and chanting
      ...
      <div className="bg-white border-b border-stone-100">
        <div className="max-w-5xl mx-auto px-8 py-12 md:py-20">
          <div className="flex items-center justify-between mb-16">
            <button onClick={() => navigate('/dashboard')} className="p-3.5 hover:bg-stone-50 rounded-2xl transition-all text-stone-400 active:scale-95 border border-transparent hover:border-stone-100 shadow-sm bg-white">
              <ChevronLeft size={28} />
            </button>
